...
from realestate.home.views import IndexView, ContactView, ListingFeed
...
urlpatterns = [
    ...
    # # # Django apps
    # url(r'^dashboard/', include('realestate.admin.urls')),  # Custom Admin Site

    # #url(r'^accounts/login/$', 'django.contrib.auth.views.login', name='login'),
    # #url(r'^accounts/logout/$', 'django.contrib.auth.views.logout', name="logout"),
    url(r'^admin/', include(admin.site.urls)),  # Enabling Admin
